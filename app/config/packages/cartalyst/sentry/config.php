...
|--------------------------------------------------------------------------
|
| Configuration specific to the puesto management component of Sentry.
|
*/
    ...
    'puestos' => array(
        ...
        */
        ...
        'model' => 'Cartalyst\Sentry\Puestos\Eloquent\Puesto',
	...
	*/
    ...
    /*
	|--------------------------------------------------------------------------
	| User Puestos Pivot Table
	|--------------------------------------------------------------------------
	|
	| When using the "eloquent" driver, you can specify the table name
	| for the user puestos pivot table.
	|
	| Default: users_puestos
	|
	*/

    'user_puestos_pivot_table' => 'users_puestos',
