                ...
                <li class="dropdown user user-menu">
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li class="user-header bg-light-blue">
                            <!--<img src="{{asset('packages/stevemo/cpanel/adminlte/img/user.jpg')}}" class="img-circle" alt="User Image" />    //gman -->
                            <img src="{{asset('packages/stevemo/cpanel/adminlte/img/yo.png')}}" class="img-circle" alt="User Image" />
                            <p>
                                {{ Sentry::getUser()->first_name }} {{ Sentry::getUser()->last_name }}
                                <small>Miembro desde {{ Sentry::getUser()->created_at->format('M. Y') }}</small>
                            </p>
                        </li>
                        <!-- Menu Body -->
                        ...
                        <li class="user-footer">
                            <div class="pull-left">
                                <a href="{{route('cpanel.users.show',array(Sentry::getUser()->id))}}" class="btn btn-default btn-flat">Perfil</a>
                            </div>
                            <div class="pull-right">
                                <a href="{{route('cpanel.logout')}}" class="btn btn-default btn-flat">Salir</a>
                            </div>
                        </li>
                    </ul>
                </li>
        ...
        <section class="sidebar">
            ...
            <div class="user-panel">
                ...
                <div class="pull-left info">
                    <p>Hola, {{ Sentry::getUser()->first_name }}</p>
                </div>
            </div>
