...
Route::group(array('prefix' => Config::get('cpanel::prefix', 'admin')), function()
{
    ...
    */
    ...
    /*
    |--------------------------------------------------------------------------
    | Cpanel Puestos Routes
    |--------------------------------------------------------------------------
    |
    |
    */
    Route::get('puestos', array(
        'as'     => 'cpanel.puestos.index',
        'uses'   => 'Stevemo\Cpanel\Controllers\PuestosController@index',
        'before' => 'auth.cpanel'
    ));
    Route::post('puestos', array(
        'as'     => 'cpanel.puestos.store',
        'uses'   => 'Stevemo\Cpanel\Controllers\PuestosController@store',
        'before' => 'auth.cpanel'
    ));
    Route::get('puestos/create', array(
        'as'     => 'cpanel.puestos.create',
        'uses'   => 'Stevemo\Cpanel\Controllers\PuestosController@create',
        'before' => 'auth.cpanel'
    ));
    Route::get('puestos/{id}/edit', array(
        'as'     => 'cpanel.puestos.edit',
        'uses'   => 'Stevemo\Cpanel\Controllers\PuestosController@edit',
        'before' => 'auth.cpanel'
    ));
    Route::put('puestos/{id}', array(
        'as'     => 'cpanel.puestos.update',
        'uses'   => 'Stevemo\Cpanel\Controllers\PuestosController@update',
        'before' => 'auth.cpanel'
    ));
    Route::delete('puestos/{id}', array(
        'as'     => 'cpanel.puestos.destroy',
        'uses'   => 'Stevemo\Cpanel\Controllers\PuestosController@destroy',
        'before' => 'auth.cpanel'
    ));
