...
class Provider implements ProviderInterface {
	...
	public function findById($id)
	{
		...
		{
			throw new UserNotFoundException("No se encontro un usuario con ID [$id].");
		}
	...
	public function findByLogin($login)
	{
		...
		{
			throw new UserNotFoundException("No se encontro un usuario con el valor de login de [$login].");
		}
	...
	public function findByCredentials(array $credentials)
	{
		...
		{
			throw new \InvalidArgumentException("Login atributo [$loginName] no fue tecleado.");
		}
		...
		if ( ! $user = $query->first())
		{
			throw new UserNotFoundException("No se encontro el usuario con las credenciales tecleadas.");
		}
		...
		foreach ($hashedCredentials as $credential => $value)
		{
			...
			{
				$message = "Un usuario fue encontrado, sin embargo las credenciales no coinciden [$credential] .";
