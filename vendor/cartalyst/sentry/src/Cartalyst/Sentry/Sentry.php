...
use Cartalyst\Sentry\Puestos\Eloquent\Provider as PuestoProvider;
use Cartalyst\Sentry\Puestos\ProviderInterface as PuestoProviderInterface;
...
class Sentry {
    ...
    /**
     * The puesto provider, used for retrieving
     * objects which implement the Sentry puesto
     * interface.
     *
     * @var \Cartalyst\Sentry\Puestos\ProviderInterface
     */
    protected $puestoProvider;
     ...
     * @param  \Cartalyst\Sentry\Puestos\ProviderInterface $puestoProvider
	...
	public function __construct(
        ...
        PuestoProviderInterface $puestoProvider = null,
	...
	)
	{
        ...
        $this->puestoProvider    = $puestoProvider ?: new PuestoProvider;
	...
	public function authenticate(array $credentials, $remember = false)
	{
		...
		{
			//throw new LoginRequiredException("El atributo [$loginCredentialKey] es requerido.");
            throw new LoginRequiredException("El atributo usuario es requerido.");
		}
	...
	public function login(UserInterface $user, $remember = false)
	{
		...
		{
			$login = $user->getLogin();
			throw new UserNotActivatedException("No se puede iniciar sesion con el usuario [$login], ha sido desactivado.");
		}
	...
	/**
	 * Gets the puesto provider for Sentry.
	 *
	 * @return \Cartalyst\Sentry\Puestos\ProviderInterface
	 */
	public function getPuestoProvider()
	{
		return $this->puestoProvider;
	}

    /**
     * Sets the puesto provider for Sentry.
     *
     * @param  \Cartalyst\Sentry\Puestos\ProviderInterface
     * @return void
     */
    public function setPuestoProvider(PuestoProviderInterface $puestoProvider)
    {
        $this->puestoProvider = $puestoProvider;
    }
    ...
    /**
     * Find thepuesto by ID.
     *
     * @param  int  $id
     * @return \Cartalyst\Sentry\Puestos\PuestoInterface  $puesto
     * @throws \Cartalyst\Sentry\Puestos\PuestoNotFoundException
     */
    public function findPuestoById($id)
    {
        return $this->puestoProvider->findById($id);
    }

    /**
     * Find the puesto by name.
     *
     * @param  string  $name
     * @return \Cartalyst\Sentry\Puestos\PuestoInterface  $puesto
     * @throws \Cartalyst\Sentry\Puestos\PuestoNotFoundException
     */
    public function findPuestoByName($name)
    {
        return $this->puestoProvider->findByName($name);
    }
     ...
     */
    public function findAllPuestos()
    {
        return $this->puestoProvider->findAll();
    }
     ...
     *
     * @param  array  $attributes
     * @return \Cartalyst\Sentry\Puestos\PuestoInterface
     */
    public function createPuesto(array $attributes)
    {
        return $this->puestoProvider->create($attributes);
    }
